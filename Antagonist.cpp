// Antagonist.cpp : Defines the entry point for the console application.
//
...
vector<Policies> EA_Downselect(vector<Policies> population) { //Binary Tournament - Take 
	...
	for (int i = 0; i < num / 2; i++) {
		...
		//cout << "S\t" << S << endl;
		if (population.at(R).fitness > population.at(S).fitness) { //The greater sign is flipped to find the largest fitness
